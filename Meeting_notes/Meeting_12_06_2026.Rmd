...
- This is what the convergence plot for the optimisation looked like for 1000 iterations

```{r, out.width="70%", echo=FALSE}
knitr::include_graphics('/Users/matthewthompson/Documents/Stellenbosch University/Masters/Research Assignment/Data_work/output/mbo1.png')
```
